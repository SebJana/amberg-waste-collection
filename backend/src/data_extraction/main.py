...
from map_extract import run_streets_coordinates
...
if __name__ == "__main__":
    ...
    # Comment out if you don't want to re-run the street/zone code mapping extraction + street coordination extraction
